    ...
    <section className={styles.info}>
      <div className={styles.info__priceStats}>
        ...
        <div>
          ...
          <p>
            1H
            <Span variacao={Number(moeda.priceChange1h)}>
              {Number(moeda.priceChange1h) < 0 ? (
                <RxTriangleDown />
              ) : (
                <RxTriangleUp />
              )}
          ...
          <p>
            1D
            <Span variacao={Number(moeda.priceChange1d)}>
              {Number(moeda.priceChange1d) < 0 ? (
                <RxTriangleDown />
              ) : (
                <RxTriangleUp />
              )}
          ...
          <p>
            1W
            <Span variacao={Number(moeda.priceChange1w)}>
              {Number(moeda.priceChange1w) < 0 ? (
                <RxTriangleDown />
              ) : (
                <RxTriangleUp />
              )}
